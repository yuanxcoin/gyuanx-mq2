...
class Message {
public:
    GyuanxMQ& gyuanxmq; ///< The owning GyuanxMQ object
    ...
    /// Constructor
    Message(GyuanxMQ& lmq, ConnectionID cid, Access access, std::string remote)
        : gyuanxmq{lmq}, conn{std::move(cid)}, access{std::move(access)}, remote{std::move(remote)} {}
